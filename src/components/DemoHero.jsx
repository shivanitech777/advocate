        ...
        <CarouselContent>
          {slides.map((slide, index) => (
            <CarouselItem key={index}>
              <section className="bg-gradient-to-br from-gray-900 to-black text-white font-serif">
                <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col-reverse lg:flex-row items-center gap-12 font-serif">
                  ...
                  >
                    <p className="text-gray-400 font-medium mb-3 font-serif">{slide.subtitle}</p>
                    <h1 className="text-4xl sm:text-5xl font-extrabold text- leading-tight mb-6 font-serif">
                      {slide.title}
                    </h1>
                    <p className="text-[#F8F7F4] mb-8 max-w-xl font-serif mx-auto lg:mx-0 ">
                      {slide.description}
                    </p>
                    <div className="flex gap-4 justify-center lg:justify-start">
                      <a
                        href="/contact"
                        className="inline-flex items-center justify-center px-6 py-3 bg-amber-500 text-white rounded-md shadow hover:bg-green-800 transform transition duration-200 font-serif"
                      >
                        {slide.btn1}
                      </a>
                      <a
                        href="/services"
                        className="inline-flex items-center justify-center px-6 py-3 border border-gray-200 text-white rounded-md hover:bg-[#B69D75] hover:text-black transition font-serif"
                      >
                        {slide.btn2}
                      </a>
                    </div>
